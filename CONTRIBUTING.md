# Contributing to Awesome RL Traffic Signals

Anyone interested in RL-based traffic signal control is welcomed to contribute to this repo:
...
2. Clone this repo to your own machine.
    ```
    git clone https://github.com/<your_username>/awesome-RL-traffic-signals.git
    ```
